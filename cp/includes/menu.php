...
?>            
    <div id="div-menu-principal">
               <ul>
                   ...
                   <li onClick="javascript:window.location = '<?php echo $directorio_personal;?>delegado_listado.php'"><div onMouseOver="javascript:this.className = 'div_hover';" onMouseOut="javascript:this.className = ''" style="width:130px;"><img src="<?php echo $directorio_imagen;?>images/delegados.png" style="position:relative;top:7px;"><a title="Ver Listado de Delegados" href="<?php echo $directorio_personal;?>delegado_listado.php" style="top: 0px;left:5px;position: relative;">delegados</a></div></li>
