    ...
    <div id="div-menu-principal">
        <ul>
            ...
            <li onClick="javascript:window.location = '<?php echo $directorio;?>panel.php';">
                <div onMouseOver="javascript:this.className = 'div_hover';" onMouseOut="javascript:this.className = ''" style="width:180px;">
                    <img src="<?php echo $directorio_imagen;?>images/comprar.png" style="position:relative;top:7px;">
                    <a title="Comprar Pasajes" href="<?php echo $directorio;?>panel.php" style="top: 0px;left:5px;position: relative;">comprar pasajes</a>
                </div>
            </li>
            <li onClick="javascript:window.location = '<?php echo $directorio_personal;?>anular_boleto.php';">
                <div onMouseOver="javascript:this.className = 'div_hover';" onMouseOut="javascript:this.className = ''" style="width:170px;">
                    <img src="<?php echo $directorio_imagen;?>images/cancelarboleto.png" style="position:relative;top:7px;">
                    <a title="Anular Boletos" href="<?php echo $directorio_personal;?>anular_boleto.php" style="top: 0px;left:5px;position: relative;">anular boleto</a>
                </div>
            </li>
            <li onClick="javascript:window.location = '<?php echo $directorio_personal;?>reporte.php'">
                <div onMouseOver="javascript:this.className = 'div_hover';" onMouseOut="javascript:this.className = ''" style="width:150px;">
                    <img src="<?php echo $directorio_imagen;?>images/movimientos.png" style="position:relative;top:7px;">
                    <a title="Ver Movimientos" href="<?php echo $directorio_personal;?>reporte.php" style="top: 0px;left:5px;position: relative;">movimientos</a>
                </div>
            </li>
        </ul>
    </div>
