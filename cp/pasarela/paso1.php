...
//                data.append('obtener_ciudades',1);
	      ...
	      <td height="320" align="center" style="background-color: #FFFFFF">
                    <form id="form1" name="form1" method="post" action="paso2.php" autocomplete="off" onSubmit="EnviaValores(); return false;">
                        <table width="900" border="0" cellpadding="0" cellspacing="0" style="background-color: #F0F0F0">
                          ...
                          <tr>
                            <td height="30"></td>
                            <td align="left"><input type="radio" name="rbt_tipo_viaje" id="radio" value="1" checked onClick="ValorRadio(this.id, 'tipo_viaje')"> Ida y Vuelta</td>
                            <td align="left"><input type="radio" name="rbt_tipo_viaje" id="radio2" value="0" onClick="ValorRadio(this.id, 'tipo_viaje')"> S&oacute;lo Ida</td>
                          <link href="css/estilos.css" rel="stylesheet" type="text/css"/>
                            <td>
