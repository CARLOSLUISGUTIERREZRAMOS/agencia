function  ValidarCamposDetalle() {
    ...
    for (var j = 1; j <= menores; j++) {
        ...
        if (ComprobarCaractValido($('#nombre_m_' + j).val()) != 1) {
            alert("El Nombre del Niño N° " + j + " contiene caracteres incorrectos");
            return false;
        }
        ...
        if (ComprobarCaractValido($('#paterno_m_' + j).val()) != 1) {
            alert("El Apellido Paterno del Niño N° " + j + " contiene caracteres incorrectos");
            return false;
        }
        ...
        if ($.trim($('#tipo_doc_m_' + j).val()) == "NI") {
            ...
            if (ComprobarCaractValido($('#materno_m_' + j).val()) != 1) {
        ...
        if ($.trim($('#tipo_doc_m_' + j).val()) == "PP") {
            ...
            if (!(/^[A-Z0-9]+$/.test($.trim($('#num_doc_m_' + j).val())))) {
                alert("Por favor verifique el Numero de Pasaporte del Niño N° " + j);
                return false;
            }
        }

        if ($.trim($('#tipo_doc_m_' + j).val()) == "ID") {

            if ($.trim($('#num_doc_m_' + j).val()) == '') {

                alert("Por favor verifique el Carné de Extranjería del Niño N° " + j);
                return false;
            }
        }
        ...
        if ($.trim($('#fecNac_m_' + j).val()) == "") {
            alert("Por favor ingrese la fecha de nacimiento del Niño N° " + j);
            return false;
        }
    }
    ...
    for (var k = 1; k <= infantes; k++) {
        ...
        if (ComprobarCaractValido($('#nombre_i_' + k).val()) != 1) {
            alert("El Nombre del Infante N° " + k + " contiene caracteres incorrectos");
            return false;
        }
        ...
        if (ComprobarCaractValido($('#paterno_i_' + k).val()) != 1) {
            alert("El Apellido Paterno del Infante N° " + k + " contiene caracteres incorrectos");
            return false;
        }
        ...
        if ($.trim($('#tipo_doc_i_' + k).val()) == "NI") {
            ...
            if (ComprobarCaractValido($('#materno_i_' + k).val()) != 1) {
                alert("El Apellido Materno del Infante N° " + k + " contiene caracteres incorrectos");
                return false;
            }
        }
        ...
        if ($.trim($('#tipo_doc_i_' + k).val()) == "PP") {
            ...
            if (!(/^[A-Z0-9]+$/.test($.trim($('#num_doc_i_' + k).val())))) {
                alert("Por favor verifique el Numero de Pasaporte del Infante N° " + k);
                return false;
            }
        }

        if ($.trim($('#tipo_doc_i_' + k).val()) == "ID") {

            if ($.trim($('#num_doc_i_' + k).val()) == '') {

                alert("Por favor verifique el Carné de Extranjería del Infante N° " + k);
                return false;
            }
        }
        ...
        if ($.trim($('#fecNac_i_' + k).val()) == "") {
            alert("Por favor ingrese la fecha de nacimiento del Infante N° " + k);
            return false;
        }
    }
    return true;
