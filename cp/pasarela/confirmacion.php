...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color: #FFFFFF">
    <tr>
    <td height="20" align="center" style="background-color: #FFFFFF">
            &nbsp;
    </td>
  </tr>
  <tr>
	...
	<tr>
		<td height="340" align="center" style="background-color: #FFFFFF"><form id="form1" name="form1" method="post" action="" autocomplete="off" onSubmit="EnviaValores(); return false;">
        <table width="900" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
              ...
              <table class="table_font" width="800">
                ...
                <tr>
                  <td height="24" align="center">Monto: <strong><?php echo $tipo_moneda_cc;?> <?php echo $total_pagar_cc;?></strong></td>
                </tr>
                <tr>
