		...
		<div style="width:900px; margin:0 auto;">
        	<form id="formRegistro" name="formRegistro" method="post" action="" autocomplete="off" style="width:900px">
                            ...
                            <table width="900" border="0" cellpadding="0" cellspacing="0" style="background-color: #F0F0F0;">
                                ...
                                <tr>
                                    ...
                                    <td  class="label_info" style="padding: 10px 10px 7px 0;">anexo:</td><td >  <input type="text" name="anexo_d" id="anexo_d" style="text-align: center;" maxlength="6" onKeyPress="javascript:return Numero(event);"/></td>
                                     <td  rowspan="3"> <button style="cursor:pointer;" id="guarda_delegado" onClick="event.preventDefault();" title="Guardar Delegado"><img src="../images/disk-black.png" /></button></td>
                                </tr>
                                <tr>
                            ...
                            <span class="span-requerido">*</span>
                                     ...
                                     <td  class="label_info" style="padding: 10px 10px 7px 0;">RPM:</td><td > <input type="text" name="rpm_d" id="rpm_d" maxlength="9" style="text-align: center;" onKeyPress="javascript:return NumeroRPM(event);" value="<?php echo $RPM;?>"/></td>
                                </tr>
                                <tr>
                            ...
                            <span class="span-requerido">*</span>
                                   ...
                                   <!--<td  class="label_info" style="padding: 10px 10px 7px 0;">RPC:</td><td >  <input type="text" name="rpc_d" id="rpc_d" maxlength="9" style="text-align: center;" onKeyPress="javascript:return Numero(event);" value="<?php echo $RPC;?>"/></td>-->
                                   <td  class="label_info" style="padding: 10px 10px 7px 0;">Departamento:</td><td >  <select name="depa_d" id="depa_d" maxlength="9" style="text-align: center;"/></td>
                                     <td  rowspan="2"> <button style="cursor:pointer;" onClick="event.preventDefault();window.location.href='delegado_listado.php';" title="Volver al listado de Delegados" ><img src="../images/table.png" /></button></td>
                                </tr>
                                 <tr>
                                    ...
                                    <!--<td  class="label_info" style="padding: 10px 10px 7px 0;">nextel:</td><td > <input type="text" name="nextel_d" id="nextel_d" maxlength="8" style="text-align: center;" onKeyPress="javascript:return NumeroNextel(event);" value="<?php echo $nextel;?>"/></td>-->
                                    <td  class="label_info" style="padding: 10px 10px 7px 0;">Provincia:</td><td > <select name="prov_d" id="prov_d" maxlength="8" style="text-align: center;" /></td>
                                </tr>
                                 <tr>
                                      ...
                                      <span class="span-requerido">*</span></td>
                                    <!--<td  class="label_info" style="padding: 10px 10px 7px 0;"></td><td > </td>-->
                                    <td  class="label_info" style="padding: 10px 10px 7px 0;">Distrito:</td><td > <select name="dist_d" id="dist_d" maxlength="8" style="text-align: center;" /></td>
                                </tr>
